...
Y = WORKS
YP= USE MSX8P (PATCHER VERSION NEEDED DUE TO DIRECT VDP/PSG WRITES INSTEAD OF GOING THROUGH THE BIOS)
Y?= RUNS BUT CONTROLLER ISSUES - REQUIRES KEYBOARD (NOT IMPLEMENTED YET) OR TWO BUTTON JOYSTICK
...
==== ============   ============================================
 ...
 N4  CHESS102.ROM   Chess Game, The (Europe).rom
 ...
 N4  COMEC112.ROM   Comecocos (Spain).rom
 ...
 N4  COMPU116.ROM   Computer Nyuumon - Computer Lessons (Japan).rom
 N5  COMPU117.ROM   Computer Othello (Japan).rom

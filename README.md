...
<b>IMPORTANT NOTICE</b> you will need to jumper the VDP interrupt to INT3 on the graphics card. Follow this link: [GFX BOARD INT](https://github.com/lesbird/MSX8#graphics-board-setup)
